...
class sudokoHome extends StatefulWidget {
  const sudokoHome({super.key});

  @override
  State<StatefulWidget> createState() => sudokoHomeState();
}

class sudokoHomeState extends State<sudokoHome> {
  bool firstRun = true;
  bool gameOver = false;
  int timesCalled = 0;
            ...
            appBar: PreferredSize(
                ...
                child: isDesktop
                    ...
                    : AppBar(
                        ...
                        title: const Text(
                          'Sudoku',
                          style: TextStyle(color: Color(0xFFFF675C)),
                        ),
                        backgroundColor: Colors.white,
                        actions: [
                          IconButton(
